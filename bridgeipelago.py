...
DiscordGuildID = 1363130850547470336
    ...
    if CoreConfig["AdvancedConfig"]["SelfHostNoWeb"] == True:
        ...
        try:
            ...
            if(int(cond) == CoreConfig["ArchipelagoConfig"]['ArchipelagoPort']):
                ...
                message = "Port Check Failed.  New port is " + str(RoomData["last_port"]) + "." + str(int(cond)) + " - " + CoreConfig["ArchipelagoConfig"]['ArchipelagoPort']
